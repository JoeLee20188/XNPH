...
%let today="14Nov2016"d;
%let mytoday=20161114;
%let yqday=&today.-30;
libname dat "E:\data";
...
run;
/* 输出数据源*/
PROC EXPORT DATA=liuaihua OUTFILE="E:\source_data\审批管理部数据源_&mytoday..xlsx" DBMS=EXCEL REPLACE;
RUN;
/*PROC EXPORT DATA=cuishou OUTFILE="E:\source_data\催收部数据源_&mytoday..xlsx" DBMS=EXCEL REPLACE LABEL;*/
/*RUN;*/
