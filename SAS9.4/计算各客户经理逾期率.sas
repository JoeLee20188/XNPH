...
group by a.sales_code,CUST_MNG;
quit;
/*删除房贷*/
data city_Rate;
set city_Rate;
...
/*run;*/
/*输出*/
PROC EXPORT DATA=cust_mng_rate OUTFILE="E:\echart_excel_to_mysql\客户经理逾期（剩余放款金额）数据.xlsx" DBMS=EXCEL replace;
RUN;
